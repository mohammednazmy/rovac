...
if __name__ == "__main__":
    ...
    # for j in range(5):
        # for i in range(2):
           ...
           # # 12V    0x2ee0
           # # '''
           # # board.set_battery_level(battery_level=0x2904)
           # print('set_motor_type')
           # time.sleep(1)
        # print('moving!!!!')
        # board.set_motor_speed([[1, 0], [2, -0.6], [3, 0], [4, -0.6]])
        # time.sleep(5)
        # print('STOP!!!!')
        # board.set_motor_speed([[1, 0], [2, 0.0], [3, 0], [4, 0.0]])
        # time.sleep(3)
        # print(j)
